            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <div className="flex items-center gap-3">
                  <Link href="/profile">
                    <img
                      src={user.photo}
                      alt="Profile"
                      className="w-10 h-10 rounded-full border-2 border-blue-500 cursor-pointer hover:scale-105 transition duration-200"
                    />
                  </Link>
                ...
                <>
                  <button
                    onClick={handlelogin}
                    className="flex items-center gap-3 bg-white border border-gray-300 rounded-lg px-5 py-2 shadow-sm hover:shadow-md hover:bg-gray-50 transition"
                  >
