...
export default function SvgSlider() {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      try {
        const [interrnshipres, jobres] = await Promise.all([
          axios.get("https://internshala-clone-6qrv.onrender.com/api/internship"),
          axios.get("https://internshala-clone-6qrv.onrender.com/api/job"),
        ]);
        setinternship(interrnshipres.data);
        setjob(jobres.data);
      } catch (error) {
        console.log(error);
      }
  ...
  const filteredInternships = internships.filter(
    (item: any) => !SlectedCategory || item.category === SlectedCategory,
  );
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-16">
        ...
        <div className="flex flex-wrap gap-4">
          <span className="text-gray-900 font-medium mt-2">
            Popular Categories:{" "}
          </span>
        ...
        {filteredInternships.map((internship: any, index: any) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mt-6">
              <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-smm">
                Internship
              </span>
              <Link
